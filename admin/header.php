...
<body>
    <div class="boxcenter">
        ...
        <div class="row mb menu">
            ...
            <li><a href="index.php?act=addsach">Sách Điện tử</a></li>
            <li><a href="index.php?act=addbl">Sách nói</a></li>
            <li><a href="index.php?act=addbl">Podcast</a></li>
            <li><a href="../taikhoan/list_taikhoan.php">Khách hàng</a></li>
