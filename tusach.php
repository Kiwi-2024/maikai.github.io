...
<div class="quanly">
    <div class="quanly_tk">
        ...
        <div class="flex-quanly">
            ...
            <div class="icon-flex1 button_color"><a href="tusach.php"><ion-icon name="reorder-four-outline"></ion-icon>
                    <p>Tủ sách cá nhân</p>
                </a></div>
    ...
    <div class="div-113">
        ...
        <div class="scrollbar">
            <?php 
            // Bắt đầu vòng lặp để hiển thị sách
            while ($row1 = mysqli_fetch_assoc($tu_sach)): 
            ?>
                <div class="sach1">
                    <img src="admin/<?php echo $row1['HinhAnhBia']; ?>" alt="">
                    <a href="mota.php?MaSach=<?php echo $row1['MaSach']; ?>">
                        <p><?php echo $row1['TenSach']; ?></p>
                    </a>
                </div>
            <?php 
            // Kết thúc vòng lặp
