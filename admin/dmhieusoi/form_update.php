...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "GET" && isset ($_GET['MaDM'])) {
        ...
        $sql = "SELECT * FROM danhmuc_sachsoi where MaDM = '$MaDM'";
...
<div class="content-header">
        <h2>Chỉnh sửa danh mục hiệu sồi</h2>
    </div>
    <div class="container-1">
    <form class="form1" action="index.php?act=updatedmhieusoi" method="POST" enctype="multipart/form-data">
